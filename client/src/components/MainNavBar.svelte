<script>
  ...
  function logout() {
    AuthStore.logout().then(() => push("#/login"));
  }
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="ml-3 relative">
            ...
            <div
              ...
              class="origin-top-right absolute right-0 mt-2 w-36 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 {menuOpen
                ? 'visible'
                : 'invisible'}"
              role="menu"
