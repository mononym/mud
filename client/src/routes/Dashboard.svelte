          ...
          <div class="bg-gray-800 flex-shrink flex flex-col">
            ...
            <div class="flex w-full">
              ...
              <button
                ...
                class="flex-1 rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-black hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400"
                type="button"
              >
